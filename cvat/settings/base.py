...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,10.0.0.18,0.0.0.0,120.130.1.226').split(',')
INTERNAL_IPS = ['127.0.0.1','10.0.0.18','0.0.0.0','120.130.1.226']
...
CACHEOPS_REDIS = {
    'host': 'cvat-redis', # redis-server is on same machine
...
LOCAL_LOAD_MAX_FILES_SIZE = 10 * 1024 * 1024 * 1024  # 10 GB
