...
class Config {
    constructor() {
        ...
        this._shortkeys = {
            ...
            start_tracking_shapes: {
                value: "ctrl+enter",
                view_value: "Ctrl + Enter",
                description: "track current interpolation boxes"
            },
            ...
            watershed: {
                value: "shift+w",
                view_value: "Shift + W",
                description: "apply watershed to the frame",
                mode: 'segmentation'
            },
            ...
            toggle_canvas: {
                value: "f7",
                view_value: "F7",
                description: "toggle view of canvas",
                mode: 'segmentation'
            },
            ...
            toggle_watershed: {
                value: "f8",
                view_value: "F8",
                description: "toggle view of watershed",
                mode: 'segmentation'
            },

            cursor_mode: {
                value: "ctrl",
                view_value: "Ctrl (Holded)",
                description: "pointer mode for zooming and dragging the frame",
                mode: 'segmentation'
            }
        };
